...
for i in range(0,len(datasetEntrenamiento)):
    for j in range(0,len(datasetEntrenamiento[i][0][0][0][1])):
        if(np.shape(datasetEntrenamiento[i][0][0][0][1][j]) == (28,50)):
            train_images.append(datasetEntrenamiento[i][0][0][0][1][j])
            train_labels.append(datasetEntrenamiento[i][0][1][0][j])
        if(np.shape(datasetPrueba[0][0][0][0][1][j]) == (28,50)):
            test_images.append(datasetPrueba[0][0][0][0][1][j])
...
plot_confusion_matrix(cm=c_matrix,classes=cm_labels,title='Matriz de confusion L1')
